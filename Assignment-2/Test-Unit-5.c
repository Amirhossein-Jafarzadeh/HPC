...
int main() {
  ...
  for(t=0;t<10000000;t++)
  {
    ...
    switch(P[0].index)
     ...
     assign_dimensions(P[0].index,0);
  }
  printf("The probability going up= %f%\nThe probability going right= %f%\nThe probability going down= %f%", up/100000, right/100000 , down/100000);
return 0;
}
void initialization(int n_s, int n_z){
  int i, j, k, r, l;
